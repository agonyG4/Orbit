...
void AppStateFacadeTest::locksPublicQmlContract()
{
    ...
    const QList<PropertyContract> properties {
        ...
        {"archiveWorkflowState", "QString", false},
    ...
    const QList<MethodContract> methods {
        ...
        {"canonicalArchiveStem(QString)", "QString"},
        {"startArchiveExtractionHere(QString,QString)", "void"},
       ...
       {"fileIconName(QString,bool,bool)", "QString"},
        {"themedIconSource(QString,int,QString,double)", "QString"},
        {"sidebarIconSource(QString,int,double)", "QString"},
        {"fileIconSource(QString,bool,bool,int,QString,double)", "QString"},
